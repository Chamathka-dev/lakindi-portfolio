        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-purple-100 focus:outline-none focus:ring-2 focus:ring-[#5C3A93] bg-white/50"
              required
            />
          </div>
          <div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#5C3A93] hover:bg-[#4A2E76] text-white font-medium py-3 rounded-xl transition-colors disabled:opacity-50"
          >
